...
function createAirplane(){
  ...
  // Material Types
  fuselageMaterial = new THREE.MeshBasicMaterial( {color: 0xD3D3D3	, wireframe: true} );
  wingMaterial = new THREE.MeshBasicMaterial( {color: 0xC0C0C0	, wireframe: true} );
  propellerMaterial = new THREE.MeshBasicMaterial( {color: 0xa9a9a9, side: THREE.DoubleSide, wireframe: true} );
  stabilizersMaterial = new THREE.MeshBasicMaterial( {color: 0xa8a8a8, side: THREE.DoubleSide, wireframe: true} );
  cockpitMaterial = new THREE.MeshBasicMaterial( {color: 0x696969, side: THREE.DoubleSide, wireframe: true, depthTest: true} );
  ...
  wings.addElement(0, 0, 0, new THREE.BoxGeometry(0.5, 0.5, 0.5), wingMaterial);  // So para fazer numero impar
  ...
  propellers.addElement(0, 0, 0, new THREE.BoxGeometry(1, 1, 0.1), propellerMaterial); // So para fazer numero impar
